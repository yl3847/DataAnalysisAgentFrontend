...
const UserMenu = ({ onClose, onLogout, isAuthenticated = true, onAuthRequest = null }) => {
          ...
          {!isAuthenticated ? (
            ...
            <div className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-sm text-gray-500 mb-6 text-center">
                Please sign in to access user settings and preferences
              </p>
              <button
                onClick={() => {
                  onClose();
            ...
            // Show normal user settings when authenticated
            <>
              {activeTab === 'profile' && (
